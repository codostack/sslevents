...
const EventFAQComponent = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-6 font-sans">
      {/* Main Container - Height reduced to 500px */}
      <div className="flex flex-col md:flex-row w-full max-w-8xl h-[580px] bg-white squared-[32px] overflow-hidden shadow-xl border border-gray-100">
        
        {/* Left Side: FAQ Content (70% Width) */}
        <div className="w-full md:w-[70%] h-full flex flex-col order-2 md:order-1">
        ...
        {/* Right Side: Narrow Image (30% Width) */}
        <div className="relative w-full md:w-[30%] h-40 md:h-full overflow-hidden order-1 md:order-2">
          <img 
